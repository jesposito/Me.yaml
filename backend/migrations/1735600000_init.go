...
func init() {
	m.Register(func(app core.App) error {
		...
		if !collectionExists("experience") {
		...
		if !collectionExists("certifications") {
		...
		if !collectionExists("share_tokens") {
		...
		if !collectionExists("ai_providers") {
		...
		if !collectionExists("import_proposals") {
