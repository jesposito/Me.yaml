...
func init() {
	m.Register(func(app core.App) error {
		...
		experienceCollection.Fields.Add(&core.SelectField{Name: "visibility", Values: []string{"public", "unlisted", "private", "password"}, MaxSelect: 1})
		...
		projectsCollection.Fields.Add(&core.SelectField{Name: "visibility", Values: []string{"public", "unlisted", "private", "password"}, MaxSelect: 1})
		projectsCollection.Fields.Add(&core.TextField{Name: "password_hash", Hidden: true})
