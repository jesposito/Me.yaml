...
- 🟡 In progress/up next: media optimization (thumb/WebP/srcset), orphan cleanup UX (bulk delete/storage usage), external media embeds, testing backlog.
...
- 7.2 Image optimization: 🔜 thumbnails, WebP conversion, responsive srcsets
